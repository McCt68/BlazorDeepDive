...
{
    // In Memory datastore. Static will be accesible when the program is running.
    public static class ServersRepository
    {
        ...
        // using LINQ to query the servers list and get those that have a matching cityName
        ...
        // I Think this creates a new server object, but why. Video 8 explain it
